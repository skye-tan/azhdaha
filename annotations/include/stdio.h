...
/* Close STREAM.
   ...
   marked with __THROW.  */
extern int fclose (LINEAR_TYPE FILE *__stream) __nonnull ((1));
...
/* Open a file and create a new stream for it.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
extern LINEAR_TYPE FILE *fopen (const char *__restrict __filename,
...
/* Open a file, replacing an existing stream with it.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
extern LINEAR_TYPE FILE *freopen (const char *__restrict __filename,
		      const char *__restrict __modes,
...
#endif
#ifdef __USE_LARGEFILE64
extern LINEAR_TYPE FILE *fopen64 (const char *__restrict __filename,
		      const char *__restrict __modes)
  __attribute_malloc__ __attr_dealloc_fclose __wur;
extern LINEAR_TYPE FILE *freopen64 (const char *__restrict __filename,
			const char *__restrict __modes,
			FILE *__restrict __stream) __wur __nonnull ((3));
#endif
...
extern LINEAR_TYPE FILE *fdopen (int __fd, const char *__modes) __THROW
  __attribute_malloc__ __attr_dealloc_fclose __wur;
#endif
...
extern LINEAR_TYPE FILE *fopencookie (void *__restrict __magic_cookie,
			  const char *__restrict __modes,
...
extern LINEAR_TYPE FILE *fmemopen (void *__s, size_t __len, const char *__modes)
  __THROW __attribute_malloc__ __attr_dealloc_fclose __wur;

/* Open a stream that writes into a malloc'd buffer that is expanded as
   necessary.  *BUFLOC and *SIZELOC are updated with the buffer's location
   and the number of characters written on fflush or fclose.  */
extern LINEAR_TYPE FILE *open_memstream (char **__bufloc, size_t *__sizeloc) __THROW
  __attribute_malloc__ __attr_dealloc_fclose __wur;
...
/* Close a stream opened by popen and return the status of its child.
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
extern int pclose (LINEAR_TYPE FILE *__stream) __nonnull ((1));

/* Create a new stream connected to a pipe running the given command.

   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
extern LINEAR_TYPE FILE *popen (const char *__command, const char *__modes)
