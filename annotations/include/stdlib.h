...
extern LINEAR_TYPE void *malloc (size_t __size) __THROW __attribute_malloc__
...
extern void free (LINEAR_TYPE void *__ptr) __THROW;
...
/* __attribute_malloc__ is not used, because if reallocarray returns
   the same pointer that was passed to it, aliasing needs to be allowed
   between objects pointed by the old and new pointers.  */
extern LINEAR_TYPE void *reallocarray (LINEAR_TYPE void *__ptr, size_t __nmemb, size_t __size)
